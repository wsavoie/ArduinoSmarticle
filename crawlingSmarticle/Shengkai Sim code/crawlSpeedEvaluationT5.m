function [crawlSpeed]=crawlSpeedEvaluationT5(dt,T,miu,miuS,D,L,D0,W0,TGait,m0,m1,MSpeed,gR,ccw)
instantPlot=1;
plotz=0;
k=5e3; g=9.81;
% m0=0.0248; m1=0.003186;
% dt=1e-5; T=18; TGait=1.6;
N=round(T/dt); % dN0=1000; %round(N/1000)
d0=0.001; u0=0.05; R=1; A=25; % A=21, 10
slow=0.00001;
% r=90/90;
